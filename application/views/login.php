                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Bienvenido</h3>
                                    </div>
                                </div>
                                <p class="text-muted text-center p-b-5">Ingrese los datos solicitados para iniciar sesión</p>
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                    <?php
